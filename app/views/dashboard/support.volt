        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form id="form-support" method="post" action="{{ url('api/support/send') }}">
        ...
        <div class="col-md-6 troubleshooting">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <p>
                        <b>How do I enable Flash in Chrome?</b>
                        <br />We use RTMP (Real Time Media Protocol) with CloudFront so Flash is needed. To enable Chrome to use
                        Flash on JREAM, please go to the url <code>chrome://settings/content/</code> &gt; Content Settings &gt; Flash &gt; Then near "Allow" click "Add", and enter <code>jream.com</code>. If it
                        does not ensure you restart chrome by visiting: <code>chrome://restart</code> (This reloads Chrome and keeps your tabs active).
                    </p>
                </div>
            </div>
        </div>
