...
<head>
    ...
    <meta name="csrf" id="csrf" data-key="" data-token="" content="">
    <title>Preview | JREAM</title>
    ...
    <link rel="mask-icon" href="./images/favicon/safari-pinned-tab.svg" color="#303030">
    <meta name="theme-color" content="#303030">

    <!-- Dependencies App -->
    <link rel="stylesheet" href="./vendor/fonts.css" type="text/css">

    <!-- App -->
    <link rel="stylesheet" href="./css/app.css?<?=random_int(1, 99999)?>" type="text/css">
    ...
    <style>
        body {
            /* Need Space to preview properly*/
            margin-top: 100px;
        }
    </style>
  </head>
      ...
      <footer>
        <div class="row">
          <div class="col-lg-12">
            ...
            <p>Made by <a href="http://thomaspark.co" rel="nofollow">Thomas Park</a>. Contact him at <a href="/cdn-cgi/l/email-protection#e89c808785899ba88a87879c9b9f899c8b80c68b8785"><span class="__cf_email__" data-cfemail="35415d5a58544675575a5a4146425441565d1b565a58">[email&#160;protected]</span></a>.</p>
