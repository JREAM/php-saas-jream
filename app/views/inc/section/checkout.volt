    ...
    <div class="panel-body">
        ...
        <div class="payment-errors"></div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <input data-stripe="number" class="form-control" placeholder="Card Number" value="{% if constant("\STAGE") != 'production' %}4242424242424242{% endif %}">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <input data-stripe="cvc" class="form-control" value="{% if constant("\STAGE") != 'production' %}100{% endif %}" />
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                {% include "inc/section/payments.volt" %}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 text-center">
                    <img src="{{ url('img/stripe.png') }}" alt="Powered by Stripe" />
                </div>
            </div>
