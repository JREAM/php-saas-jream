...
## 5-28-17
- Am attempting to work at other projects, the Phalcon update and issues keep getting me.
- Downtime today for 30 minutes due to DNS transfer, no more GoDaddy ever again.
- DNS was missing CNAME to external Database, unsure how it worked prior to that as all DNS is routed through an external service not the DNS host.

## 5-26-17
- Fixed an exception Array to String error
- Bug: Issue with SendGrid Whitelist IP I need to sort out, first error received.
